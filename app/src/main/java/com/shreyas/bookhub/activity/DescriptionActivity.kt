...
import com.shreyas.bookhub.database.BookDatabase
import com.shreyas.bookhub.database.BookEntity
import com.shreyas.bookhub.util.ConnectionManager
...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        queue.add(jsonRequest)
            ...
            val dialogue = AlertDialog.Builder(this@DescriptionActivity)
            dialogue.setTitle("Failed")
            dialogue.setMessage("The app is not connected to Internet")
